...
class OrbitalCircleView(ctx : Context) : View(ctx) {
    ...
    data class OrbitalCircle(var i : Int) {

        private var curr : OCNode = OCNode(0)
    ...
    companion object {
        ...
        fun create(activity: Activity) : OrbitalCircleView {
            val view : OrbitalCircleView = OrbitalCircleView(activity)
